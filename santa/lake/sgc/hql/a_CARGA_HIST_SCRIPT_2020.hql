...
CREATE TEMPORARY TABLE gestiones_hist_2020 AS
	...
	WHERE TO_DATE(fec_gestion_alta) >= '2020-01-01' 
		AND TO_DATE(fec_gestion_alta) <= '2020-06-28'
...
SELECT * FROM gestiones_hist_2020;


# HIVE DROP PARTITION HIST (EJEMPLO 2019):

ALTER TABLE bi_corp_staging.rio56_gestiones 
DROP IF EXISTS PARTITION(partition_date = '2020-hist')


# HDFS REMOVE partition_date=2019-hist

hdfs dfs -rm -r /santander/bi-corp/staging/rio56/fact/gestiones/partition_date=2020-hist
