...
def procesamiento(val):
	...
	try:	
		for i in range(0,200):
			...
			archivo_sal = open("/RIO35/INTERFACE/responsys_api.txt","a")
...
try:
	...
	procesar = int(sys.argv[1])
	
	for i in range(1,procesar):
		voff=i*200
        
		conexion()
		
		if i=='1':
			remover("/RIO35/INTERFACE/responsys_api.txt")
