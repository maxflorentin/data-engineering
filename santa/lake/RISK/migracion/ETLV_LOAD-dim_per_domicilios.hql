...
, CAST(nvl(malpe_pedt003.penumblo, '0') AS INT) ds_per_nro_calle
...
AND malpe_pedt003.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_Malpe-Daily') }}'
"