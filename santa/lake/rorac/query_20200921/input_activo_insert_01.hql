...
SELECT 
	...
	RE.cod_ren_producto_gest AS cod_ren_producto , 
	RE.cod_ren_pers_ods ,
...
WHERE partition_date = '2020-06-30' AND fc_ifrs_provision IS NOT NULL;
...
SELECT 
	...
	RE.cod_ren_area_negocio_niv_9 cod_ren_division ,
	RE.cod_ren_producto_gest  cod_ren_producto , 
	RE.cod_ren_pers_ods ,
