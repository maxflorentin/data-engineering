...
--      _                       __                           _                        ___   
--     (_)____   ____   __  __ / /_     ____   ____ _ _____ (_)_   __ ____     _   __|__ \  
--    / // __ \ / __ \ / / / // __/    / __ \ / __ `// ___// /| | / // __ \   | | / /__/ /  
--   / // / / // /_/ // /_/ // /_     / /_/ // /_/ /(__  )/ / | |/ // /_/ /   | |/ // __/ _ 
--  /_//_/ /_// .___/ \__,_/ \__/    / .___/ \__,_//____//_/  |___/ \____/    |___//____/(_)
--           /_/                    /_/                                                     
-- IFRS9 TEMP
--
...
----------------------------------------------------
CREATE TEMPORARY TABLE IF NOT EXISTS input_pasivo AS 
SELECT 
	...
	RE.cod_ren_producto_generic  cod_ren_producto , 
	RE.cod_ren_pers_ods ,
	CASE WHEN RE.cod_ren_producto_niv_3 = 'BG2'THEN SUM(RE.fc_ren_resultado_total_ml) ELSE 0 END AS fc_ren_margenmes ,
	CASE WHEN RE.cod_ren_producto_niv_3 = 'BG2'THEN SUM(RE.fc_ren_saldo_medio_total_ml) ELSE 0 END AS fc_ren_sdbsmv ,
	...
	CASE WHEN RE.cod_ren_producto_niv_3 = 'BG2' THEN SUM(RE.fc_ren_resultado_total_real_ml) ELSE 0 END AS fc_ren_interes ,
...
WHERE RE.partition_date = '2020-06-30'
	...
	AND RE.cod_ren_producto_niv_3 IN ('BG2','BG3')
	AND RE.cod_ren_contenido IN ('PLZ','CTA','COM','CCL','CTB','ROF') 
...
set mapred.job.queue.name=root.dataeng;
set hive.exec.dynamic.partition.mode=nonstrict;
INSERT OVERWRITE TABLE bi_corp_common.bt_ror_input_pasivo_v2
