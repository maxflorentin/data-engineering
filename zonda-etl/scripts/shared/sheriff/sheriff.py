...
def get_zonda_platform_token():
    url = "https://platform-dev-zonda-zagw.apps.ocp.ar.bsch:443/api/v1/auth/token"

    payload = {}
    headers = {
        'Authorization': 'Basic c3J2Y2VuZ2luZWVyYmk6MURVRlY3dVpFMURwWXBy'
    }
...
def sheriff():
    ...
    if socket.gethostname().__contains__('aws'):
        get_zonda_platform_token()
    else:
