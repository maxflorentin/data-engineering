...
SELECT
       ...
       '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_BSN_Daily_Dashboard') }}' as partition_date
...
(
  ...
  WHERE
    c.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_BSN_Daily_Dashboard') }}'
...
FULL OUTER JOIN
  (
    ...
    WHERE
      partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_working_day', dag_id='LOAD_BSN_Daily_Dashboard') }}'
...
FULL OUTER JOIN
  (
    ...
    FROM
      bi_corp_common.stk_chq_cesionados chq
    WHERE
      partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_month_last_working_day', dag_id='LOAD_BSN_Daily_Dashboard') }}'
      AND chq.cod_chq_evento = 'ALTA'
    GROUP BY
      chq.cod_chq_segmento,
      chq.cod_chq_subsegmento,
...
FULL OUTER JOIN
  (
    ...
    FROM
      bi_corp_common.stk_chq_cesionados chq
    WHERE
      partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_week_same_date', dag_id='LOAD_BSN_Daily_Dashboard') }}'
      AND chq.cod_chq_evento = 'ALTA'
    GROUP BY
      chq.cod_chq_segmento,
      chq.cod_chq_subsegmento,
...
FULL OUTER JOIN
  (
    ...
    FROM
      bi_corp_common.stk_chq_cesionados chq
    WHERE
      partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_month_working_day', dag_id='LOAD_BSN_Daily_Dashboard') }}'
      AND chq.cod_chq_evento = 'ALTA'
    GROUP BY
      chq.cod_chq_segmento,
      chq.cod_chq_subsegmento,
...
FULL OUTER JOIN
  (
    ...
    FROM
      bi_corp_common.stk_chq_cesionados chq
    WHERE
      partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_year_working_day', dag_id='LOAD_BSN_Daily_Dashboard') }}'
      AND chq.cod_chq_evento = 'ALTA'
    GROUP BY
      chq.cod_chq_segmento,
      chq.cod_chq_subsegmento,
...
FULL OUTER JOIN
  (
    ...
    FROM
      bi_corp_common.stk_chq_cesionados chq
    WHERE
      partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_year_last_working_day', dag_id='LOAD_BSN_Daily_Dashboard') }}'
      AND chq.cod_chq_evento = 'ALTA'
    GROUP BY
      chq.cod_chq_segmento,
      chq.cod_chq_subsegmento,
