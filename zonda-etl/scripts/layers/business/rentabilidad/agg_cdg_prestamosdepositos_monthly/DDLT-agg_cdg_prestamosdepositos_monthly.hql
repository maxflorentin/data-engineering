CREATE EXTERNAL TABLE IF NOT EXISTS  bi_corp_business.agg_cdg_prestamosdepositos_monthly (
  ...
  fc_ren_saldo_ponderado_ml DECIMAL(20,4),
  fc_ren_saldo_ponderado_mo DECIMAL(20,4),
  fc_ren_contratos INT
)
PARTITIONED BY(partition_date string)
STORED AS PARQUET
LOCATION
    '${DATA_LAKE_SERVER}/santander/bi-corp/business/rentabilidad/agg_cdg_prestamosdepositos_monthly'