CREATE VIEW IF NOT EXISTS bi_corp_business.view_cheques_cantidad_operaciones AS
...
from bi_corp_staging.malzx_alzxucgr cgr
 ...
 where t030.pecdgent= '0072' and cgr.cod_nup not in ('00199863', '00199865', '03846180')
