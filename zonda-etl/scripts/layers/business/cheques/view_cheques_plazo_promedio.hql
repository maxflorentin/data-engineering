CREATE VIEW IF NOT EXISTS bi_corp_business.view_cheques_plazo_promedio AS
select count(*) as cant_ope
       ,avg(plazo) as prom_plazo_acre
     ,case tpo_linea
...
where cod_est_tramite in ('22', '23', '24') and t030.pecdgent= '0072' and cgr.cod_nup not in ('00199863', '00199865', '03846180')
