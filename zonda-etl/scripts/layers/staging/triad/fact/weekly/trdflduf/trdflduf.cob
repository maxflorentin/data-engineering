              ...
              05  UA.
                  ...
                  20  RV-ACCT-SEGMENT OCCURS 12.
                      25  MONTHLY-SEGMENT OCCURS 12.
                        ...
                        30  FILLER          PIC X(10).
                  20  DATE-OPEN         PIC 9(08).
                  20  DATE-CLOSED       PIC 9(08).
                  20  PROD-TYPE         PIC 9(01).
                  20  RCPT-TYPE         PIC 9(01).
                  20  CURR-BALANCE      PIC S9(09) BINARY.
                  20  START-ARREARS     PIC 9(08).
                  20  AVG-RCPT-TERM     PIC S9(03) BINARY.
                  20  MONTHLY-SEGMENT OCCURS 12.
