CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_staging.rio32_seg_derivacion_inteligente_na(
...
LOCATION '${DATA_LAKE_SERVER}/santander/bi-corp/staging/rio32/dim/seg_derivacion_inteligente_na';