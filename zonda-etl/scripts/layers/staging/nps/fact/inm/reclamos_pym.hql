...
insert overwrite table bi_corp_staging.qualtrics_nps_reclamos_pym
...
partition_date
FROM bi_corp_staging.rio61_nps_reclamos_pym lateral view explode(array(nps,comentarios_reclamos)) orig_table_alias as value
