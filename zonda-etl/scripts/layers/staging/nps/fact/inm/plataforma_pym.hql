...
insert overwrite table bi_corp_staging.qualtrics_nps_plataforma_pym
...
partition_date
FROM bi_corp_staging.rio61_nps_plataforma_pym lateral view explode(array(nps,comentarios_visita_suc)) orig_table_alias as value
where partition_date BETWEEN '2019-01-01' and '2019-12-31'