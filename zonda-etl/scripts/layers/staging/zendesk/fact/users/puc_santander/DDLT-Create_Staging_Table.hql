CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_staging.zendesk_usr_puc_santander
    (
       usr_id                              string,
       usr_url                             string,
       usr_name                            string,
    ...
    LOCATION
      '${DATA_LAKE_SERVER}/santander/bi-corp/staging/zendesk/fact/users/puc-santander'