...
INSERT OVERWRITE TABLE bi_corp_staging.malbgc_bgdtmco PARTITION(partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='date_from', dag_id='LOAD_STG_Malbgc_Updates_BIS') }}')
SELECT
