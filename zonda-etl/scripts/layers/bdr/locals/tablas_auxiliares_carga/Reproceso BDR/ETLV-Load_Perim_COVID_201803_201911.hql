...
with  contrato_org as
 ...
 SELECT distinct entidad
    ...
    and partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_malug_ugdtmae', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
) 
...
select corg.entidad
    ...
    where df.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_malug_ugdtmae', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
union all
 SELECT     entidad
            ,oficina
            ,cuenta
