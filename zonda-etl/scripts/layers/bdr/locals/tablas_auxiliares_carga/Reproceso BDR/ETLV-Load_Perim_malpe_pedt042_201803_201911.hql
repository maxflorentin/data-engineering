...
partition(partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_malpe_pedt042', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}')
...
where partition_date = '2019-12-04'
	and peestope = 'C'