CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_bdr.normalizacion_id_contratos_history(
id_cto_bdr string,
source string,
...
STORED AS parquet
LOCATION '${DATA_LAKE_SERVER}/santander/bi-corp/bdr/normalizacion_id_contratos_history';