...
LOCATION '/santander/bi-corp/bdr/aux_garant_contratos_div';
...
PARTITIONED BY (partition_date string) 
LOCATION '/santander/bi-corp/bdr/aux_garant_calif_pais';
...
PARTITIONED BY (partition_date string) 
LOCATION '/santander/bi-corp/bdr/aux_garant_calif_empresa';
...
PARTITIONED BY (partition_date string) 
LOCATION '/santander/bi-corp/bdr/aux_garant_garantias_especificas_div';
...
PARTITIONED BY (partition_date string) 
LOCATION '/santander/bi-corp/bdr/aux_garant_garantias_genericas';
...
PARTITIONED BY (partition_date string) 
LOCATION '/santander/bi-corp/bdr/aux_garant_garantias_contratos_div';
...
PARTITIONED BY (partition_date string) 
LOCATION '/santander/bi-corp/bdr/aux_garant_garantias_contratos_inicial_div';
