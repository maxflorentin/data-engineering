...
WHERE
data_date_part <=  '{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_especies', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
AND fec_info <= '{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
