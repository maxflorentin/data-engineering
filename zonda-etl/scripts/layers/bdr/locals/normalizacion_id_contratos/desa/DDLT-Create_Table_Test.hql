CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_bdr.test_normalizacion_id_contratos(
id_cto_bdr string
,source string
...
STORED AS PARQUET
LOCATION '${DATA_LAKE_SERVER}/santander/bi-corp/bdr/desa/test_normalizacion_id_contratos';