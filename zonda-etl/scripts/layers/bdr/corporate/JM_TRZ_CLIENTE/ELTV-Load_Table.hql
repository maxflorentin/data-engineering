...
select  '23100' as G7015_S1EMP
        ...
        ,rpad(ctp.shortname, 50, ' ') as G7015_CODSISTE
        ,cbb.g4093_fchfin  as G7015_FEC_HAS
        ,'{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='BDR_LOAD_Tables-Monthly') }}'  as G7015_FEC_MOD
from         
(
    ...
    from bi_corp_bdr.jm_client_bii cbb 
     where cbb.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Monthly') }}'   
