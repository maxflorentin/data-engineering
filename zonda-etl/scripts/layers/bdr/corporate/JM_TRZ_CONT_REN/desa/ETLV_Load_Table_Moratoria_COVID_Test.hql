...
--Fogar Nómina
INSERT INTO TABLE bi_corp_bdr.test2_jm_trz_cont_ren 
...
on 
 lpad(cast(cov.sucursal as string) ,4,'0') = ncr.cred_cod_centro
and lpad(cast(cov.nro_cuenta as string),12,'0') = ncr.cred_num_cuenta 
and lpad(cast(cov.codigo_producto as string),2,'0') = ncr.cred_cod_producto
and lpad(cast(cov.codigo_subproducto  as string),4,'0') = ncr.cred_cod_subprodu_altair
inner join 
(
    select cbi.g4095_contra1
            ,cbi.g4095_fechaper
