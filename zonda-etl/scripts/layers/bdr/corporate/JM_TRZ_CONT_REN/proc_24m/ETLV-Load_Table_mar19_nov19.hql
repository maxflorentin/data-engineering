...
and c.data_date_part = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
and r.fec_altareg between '{{ ti.xcom_pull(task_ids='InputConfig', key='first_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
and '{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
),
...
'{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}' as partition_date
FROM renum_moria r
...
on x.data_date_part = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
and x.fec_yyyymmdd = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
WHERE n_old.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}';
...
and p.pefecest between '{{ ti.xcom_pull(task_ids='InputConfig', key='first_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
and '{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
and p.peestope = 'C'
),
...
and r.mig_old_fech_baja between '{{ ti.xcom_pull(task_ids='InputConfig', key='first_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
and '{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
),
...
and x.fec_yyyymmdd = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
WHERE n_old.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
AND r.partition_date between '{{ ti.xcom_pull(task_ids='InputConfig', key='first_working_day', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}'
AND '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day', dag_id='LOAD_BDR_RENUMERACION_mar19_nov19') }}';
