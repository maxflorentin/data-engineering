...
-- where r.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
where r.partition_date = '2019-12-19' -- valor fijo para procesar hasta DICIEMBRE 19
and c.data_date_part = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
and r.fec_altareg between '{{ ti.xcom_pull(task_ids='InputConfig', key='first_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
and '{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
),
...
'{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='LOAD_BDR_RENUMERACION_mar18') }}' as partition_date
FROM renum_moria r
...
on x.data_date_part = '20200617'
and x.fec_yyyymmdd = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
WHERE n_old.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='LOAD_BDR_RENUMERACION_mar18') }}';
...
-- and p.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
and p.partition_date = '2019-12-04' -- valor fijo para procesar hasta noviembre 2019
and p.pefecest between '{{ ti.xcom_pull(task_ids='InputConfig', key='first_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
and '{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
and p.peestope = 'C'
),
...
-- and p_old.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
and r.mig_old_fech_baja between '{{ ti.xcom_pull(task_ids='InputConfig', key='first_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
and '{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
),
...
and x.fec_yyyymmdd = '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
WHERE n_old.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
AND r.partition_date between '{{ ti.xcom_pull(task_ids='InputConfig', key='first_working_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}'
AND '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day', dag_id='LOAD_BDR_RENUMERACION_mar18') }}';
