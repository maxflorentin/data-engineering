...
(         
            ...
            from 
                (
                    ...
                    where cov.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='bdr_max_partition_saldos_tarjetas_covid', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201912_202103') }}'
...
(
    ...
    where ncr.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201912_202103') }}'
) ncr
on 
