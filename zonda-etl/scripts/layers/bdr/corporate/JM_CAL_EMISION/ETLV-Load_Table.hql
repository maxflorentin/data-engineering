...
create temporary table tmp_jm_cal_emision as 
   select '23100' as e0665_s1emp,
          ...
          '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day', dag_id='BDR_LOAD_Tables-Monthly') }}' as e0665_feccali,
          '00000' as e0665_codmercd,
          '9999-12-31' as e0665_fechasta,
          rpad(nvl(esp.cal_consultora,' '), 40, ' ') as e0665_califmae,
          '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day', dag_id='BDR_LOAD_Tables-Monthly') }}' as e0665_fecultmo
    from (select *,
...
select tmp.e0665_s1emp,
  ...
  left join bi_corp_bdr.jm_cal_emision ce1
   ...
   and ce1.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_month_partition_bdr', dag_id='BDR_LOAD_Tables-Monthly') }}';