...
,case
   when fec_vcto >= '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day', dag_id='BDR_LOAD_Tables-Monthly') }}' then
...
, LPAD(	nvl(num_persona,'0'), 9,'0') as G4124_IDNUMCLI
, 'N' as G4124_INDBLO
, 'N' as G4124_INDRGOSB
, 'N' as G4124_INDCOBPF
, 'S' as G4124_VALASEJU
            ...
            UNION ALL
                ...
                from 
                    (
                        ...
                        where partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Monthly') }}'--'2020-08'
