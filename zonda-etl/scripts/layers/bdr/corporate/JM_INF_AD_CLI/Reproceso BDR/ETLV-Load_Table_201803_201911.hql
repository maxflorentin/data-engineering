...
select DISTINCT lpad(`311_numper`, 9, '0') as num_persona
 ...
 where partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_malbgc_acreditaciones', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
 ;
...
SELECT
'{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}' as H0780_FEOPERAC,
23100 H0780_S1EMP,
...
'   ' H0780_CODDIV,
'{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}' as H0780_FECHAACT,
'{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}' as H0780_FECULTMO,
