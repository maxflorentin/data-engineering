  ...
  FROM
       (
        ...
        INNER JOIN bi_corp_bdr.normalizacion_id_contratos b
              ...
              AND b.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
        ...
        WHERE a.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
          ...
          AND cg.data_date_part between      '{{ ti.xcom_pull(task_ids='InputConfig', key='first_working_day_arda', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
...
INNER JOIN (
            SELECT r9746_contra1, max(r9746_fecmvto) as ult_mov
             ...
             WHERE PARTITION_DATE = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
...
INNER JOIN bi_corp_bdr.normalizacion_id_contratos nc
       ...
       AND nc.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
...
INNER JOIN santander_business_risk_arda.contratos_garra cg
       ...
       AND cg.data_date_part = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_month_last_working_day_arda', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'

 WHERE fl.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
...
-- PERSONAS CON CONTRATOS CON IMPORTE IRREGULAR > 0
       ...
       where data_date_part between     '{{ ti.xcom_pull(task_ids='InputConfig', key='first_working_day_arda', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
                                    and '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
...
INNER JOIN bi_corp_bdr.normalizacion_id_contratos cmap
     ...
     AND cmap.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
LEFT JOIN bi_corp_bdr.jm_trz_cont_ren ren
      ON ren.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
 ...
 WHERE core.partition_date = '2019-12-04'
   ...
   AND concat(substr(core.PEFECEST,1,4),substr(core.PEFECEST,6,2)) = '{{ ti.xcom_pull(task_ids='InputConfig', key='month', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
...
SELECT cod_entidad, cod_centro, num_cuenta, cod_producto, cod_subprodu_altair, cod_marca, min(fec_castigo) fec_castigo
 ...
 WHERE data_date_part between     '{{ ti.xcom_pull(task_ids='InputConfig', key='first_calendar_day_arda', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
                              and '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
   AND cod_marca = 'FA'
...
SELECT empresa, cod_baremo_local, cod_baremo_global
 ...
 WHERE cod_negocio_local = '1'
   AND '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
...
SELECT
'{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}' AS R9746_FEOPERAC,
...
where core_fimp.data_date_part between '{{ ti.xcom_pull(task_ids='InputConfig', key='first_calendar_day_arda', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}' and nvl(regexp_replace(cancelados.ult_act, '-', ''), '{{ ti.xcom_pull(task_ids='InputConfig', key='last_working_day_arda', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}')
and (confa.fec_castigo is null or confa.fec_castigo = '9999-12-31' or confa.fec_castigo = '0001-01-01' or regexp_replace(substring(confa.fec_castigo, 1, 7), '-', '') = '{{ ti.xcom_pull(task_ids='InputConfig', key='month', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}')
group by '{{ ti.xcom_pull(task_ids='InputConfig', key='last_calendar_day', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}',
...
--CONDICIONES GENERALES DEL INSERT
WHERE fl.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}'
...
WITH canceladosPrimerDia AS ( --solo me quedo con los cancelados el 1/12
  SELECT c.id_cto_bdr
	...
	WHERE c.fec_cancelacion = '{{ ti.xcom_pull(task_ids='InputConfig', key='first_calendar_day_arda', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}' --'${primerDiaDeEsteMes}'
),
flujosMesAnterior AS ( --todos los flujos de NOVIEMBRE ordenados por fecha de movimiento
	...
	FROM bi_corp_bdr.jm_flujos fl
	WHERE fl.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_month_partition_bdr', dag_id='BDR_LOAD_Tables-Reproceso_BDR_Monthly_201803_201911') }}' --'${mesAnterior}'
),
