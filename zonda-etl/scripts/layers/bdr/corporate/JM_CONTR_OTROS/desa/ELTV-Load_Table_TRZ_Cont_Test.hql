 ...
 from 
       (
           select g7025_s1emp, g7025_contra1, g7025_emp_ant, g7025_cont_ant, min(g7025_fealtrel) as g7025_fealtrel, 
            ...
            from bi_corp_bdr.test2_jm_trz_cont_ren 
        ...
        (
            select *
            from bi_corp_bdr.test_jm_contr_otros 
            where partition_date  = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Monthly-Desa') }}'
        ) ctr
...
select 
        ...
        ,ctr.e0623_finiutct
        ,ctr.e0623_ffinutct
        from bi_corp_bdr.test_jm_contr_otros ctr
                left join bi_corp_bdr.temp_jm_contr_otros tco
                       on tco.e0623_contra1 = ctr.e0623_contra1 
        where ctr.partition_date  = '{{ ti.xcom_pull(task_ids='InputConfig', key='month_partition_bdr', dag_id='BDR_LOAD_Tables-Monthly-Desa') }}'
