CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.bt_ben_beneficioscliente (
  cod_per_nup int,
...
STORED AS PARQUET
LOCATION
  '${DATA_LAKE_SERVER}/santander/bi-corp/common/beneficios/fact/bt_ben_beneficioscliente'
