CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.stk_pre_reestructuraciones (
...
STORED AS PARQUET
LOCATION
  '${DATA_LAKE_SERVER}/santander/bi-corp/common/prestamos/stk_pre_reestructuraciones';
