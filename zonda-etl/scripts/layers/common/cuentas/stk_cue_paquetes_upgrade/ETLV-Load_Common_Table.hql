...
and exa_productos.partition_date= case when '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_CMN_Cuentas_Hist2') }}' < '2021-03-22' then '2021-03-22' else '{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_exa_dim_productos', dag_id='LOAD_CMN_Cuentas_Hist2') }}' end
where bgdtrpp.partition_date= '{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_malbgc_bgdtrpp', dag_id='LOAD_CMN_Cuentas_Hist2') }}'
...
and partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='previous_partition_date', dag_id='LOAD_CMN_Cuentas_Hist2') }}';
...
SELECT
	  ...
	  '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_CMN_Cuentas_Hist2') }}' as partition_date
...
where no_upg.partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='previous_partition_date', dag_id='LOAD_CMN_Cuentas_Hist2') }}'
