CREATE VIEW `bi_corp_common.vbt_cue_bajas` AS WITH max_partition_date AS (
    SELECT MAX(`bgdtaux`.`partition_date`) AS `partition_date` FROM `bi_corp_staging`.`bgdtaux`
                                              ...
                                              SELECT
                                                  ...
                                                  `aux`.`fecha_cierre` AS `dt_cue_baja`,
                                                  'TBD' AS `cod_cue_canal`,
                                                  'TBD' AS `cod_cue_legajo`,
                                                  'TBD' AS `desc_motivo_baja`
                                              FROM
