CREATE EXTERNAL TABLE IF NOT EXISTS BI_CORP_COMMON.BT_EML_SKIPPED (
...
LOCATION '${DATA_LAKE_SERVER}/santander/bi-corp/common/interacciones_canales/eml/fact/bt_eml_skipped'