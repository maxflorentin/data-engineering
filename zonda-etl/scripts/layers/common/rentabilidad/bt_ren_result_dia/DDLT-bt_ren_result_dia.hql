CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.bt_ren_result_dia (
...
LOCATION '${DATA_LAKE_SERVER}/santander/bi-corp/common/rentabilidad/fact/bt_ren_result_dia'