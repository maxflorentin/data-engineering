CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.dim_ren_bcacorp (
    cod_ren_pais INT ,
	cod_ren_bca_corp STRING ,
...
LOCATION
  '${DATA_LAKE_SERVER}/santander/bi-corp/common/rentabilidad/dim/dim_ren_bcacorp';