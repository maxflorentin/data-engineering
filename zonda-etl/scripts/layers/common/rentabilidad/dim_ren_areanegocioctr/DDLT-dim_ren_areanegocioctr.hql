CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.dim_ren_areanegocioctr (
    cod_ren_pais INT ,
...
LOCATION
  '${DATA_LAKE_SERVER}/santander/bi-corp/common/rentabilidad/dim/dim_ren_areanegocioctr';