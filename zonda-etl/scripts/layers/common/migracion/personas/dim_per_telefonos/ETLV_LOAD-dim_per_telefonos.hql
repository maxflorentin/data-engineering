...
INSERT OVERWRITE TABLE bi_corp_common.dim_per_telefonos
PARTITION(partition_date)
SELECT malpe_pedt023.penumper cod_per_nup
...
WHERE malpe_pedt023.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_STG_Malpe-Daily') }}'
"