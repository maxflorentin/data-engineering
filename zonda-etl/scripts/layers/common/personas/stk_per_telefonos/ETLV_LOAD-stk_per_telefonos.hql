...
, CASE WHEN malpe_pedt023.pefecalt='0001-01-01' THEN NULL ELSE malpe_pedt023.pefecalt END   dt_per_fecha_alta
...
WHERE malpe_pedt023.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_CMN_Personas-Daily') }}'
"