...
select
    ...
    null as cod_inv_especie_sigla,
    null as cod_inv_especie_cvsa,
    null as cod_inv_categoria_cvsa,
    null as ds_inv_instrumento,
    ...
    null as cod_inv_secuencia_boleto,
    ...
    null as cod_inv_operador,
    null as fc_inv_arancel,
    null as fc_inv_arancel_porc,
    null as fc_inv_iva,
    null as fc_inv_iva_mercado,
    null as fc_inv_iva_nocat,
    null as fc_inv_iva_perc,
    null as fc_inv_iva_porc,
    null as fc_inv_iva1_porc_derechosb,
    null as fc_inv_iva1_derechosb,
    null as ds_inv_tipo_iva,
    null as fc_inv_neto,
    null as ds_inv_neto_en_letras,
    null as fc_inv_precio_promedio,
    null as fc_inv_derechosm,
    null as fc_inv_derechosb,
    null as fc_inv_derechos_porc,
    null as fc_inv_derechosb_porc,
    null as fc_inv_derechosm_porc,
    null as int_inv_relacion_baja,
    null as ds_inv_relacion_baja,
    ...
    null as cod_inv_instancia,
    null as cod_inv_tipo_boleto,
    ...
    null as cod_inv_mercado_operacion,
    null as cod_inv_cuenta_caja,
...
left join bi_corp_common.dim_inv_especies_titulos d on d.cod_inv_especie = p.s_cod_especie and d.partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_CMN_Inversiones_hist') }}'
where p.partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_CMN_Inversiones_hist') }}' and if(from_unixtime(unix_timestamp(p.s_fecha_orden,'dd-MMM-yy'),'yyyy-MM-dd') = 'NULL', from_unixtime(unix_timestamp(p.s_fecha_orden,'dd-MMM-yyyy'),'yyyy-MM-dd'), from_unixtime(unix_timestamp(p.s_fecha_orden,'dd-MMM-yy'),'yyyy-MM-dd')) >= from_unixtime(unix_timestamp('2020-10-01' , 'yyyy-MM-dd'))
...
left join bi_corp_common.dim_inv_especies_titulos d on d.cod_inv_especie = s.s_cod_especie and d.partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_CMN_Inversiones_hist') }}'
