...
left join bi_corp_staging.alcen_laboral l on tpo_empleo='0' and l.cod_sucursal = p.cod_sucursal and l.nro_solicitud = p.nro_solicitud and trim(l.nro_participante) = trim(p.nro_participante) and l.partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_CMN_Admision_Ind-Daily') }}'
