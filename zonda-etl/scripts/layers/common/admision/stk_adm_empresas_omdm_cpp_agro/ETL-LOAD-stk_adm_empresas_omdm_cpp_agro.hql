...
lateral view json_tuple(json,
    ...
    agroGastosEstructura,
    agroProdLtLeche
where partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_CMN_Admision_OMDM_Empresas') }}' and label like 'Agro%';


INSERT OVERWRITE TABLE bi_corp_common.stk_adm_empresas_omdm_cpp_agro
...
select
    ...
    cast(omdm.agroProdLtLeche as int) as int_adm_agroprodltleche,
