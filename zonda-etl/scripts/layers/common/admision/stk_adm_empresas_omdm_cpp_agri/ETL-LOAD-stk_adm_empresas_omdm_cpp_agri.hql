...
lateral view json_tuple(json,
    ...
    zonaCultivo,
    agriZona
where partition_date = '{{ ti.xcom_pull(task_ids='InputConfig', key='partition_date', dag_id='LOAD_CMN_Admision_OMDM_Empresas') }}' and label like 'Agri%';


INSERT OVERWRITE TABLE bi_corp_common.stk_adm_empresas_omdm_cpp_agri
...
select
    ...
    omdm.descCultivo as ds_adm_cultivo,
