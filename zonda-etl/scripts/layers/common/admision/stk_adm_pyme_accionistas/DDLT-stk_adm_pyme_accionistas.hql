CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.stk_adm_pyme_accionistas (
...
STORED AS PARQUET
LOCATION
  '${DATA_LAKE_SERVER}/santander/bi-corp/common/admision/stk_adm_pyme_accionistas';