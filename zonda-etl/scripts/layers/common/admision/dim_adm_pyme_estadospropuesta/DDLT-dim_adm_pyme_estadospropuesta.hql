CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.dim_adm_pyme_estadospropuesta (
...
STORED AS PARQUET
LOCATION
  '${DATA_LAKE_SERVER}/santander/bi-corp/common/admision/dim_adm_pyme_estadospropuesta';