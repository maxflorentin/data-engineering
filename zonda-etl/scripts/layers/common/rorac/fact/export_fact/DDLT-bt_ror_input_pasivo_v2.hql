CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.bt_ror_input_pasivo (	
...
LOCATION
  '${DATA_LAKE_SERVER}/santander/bi-corp/common/rorac/fact/export_fact/bt_ror_input_pasivo'
