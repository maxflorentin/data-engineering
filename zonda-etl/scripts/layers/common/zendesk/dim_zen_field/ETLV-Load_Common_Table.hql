...
where partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_zendesk_tk_fields_santander_ar', dag_id='LOAD_CMN_Zendesk') }}'
...
where partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_zendesk_tk_fields_puc_santander', dag_id='LOAD_CMN_Zendesk') }}'
...
where partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_zendesk_tk_fields_comex_santander', dag_id='LOAD_CMN_Zendesk') }}'