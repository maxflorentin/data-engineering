...
WHERE partition_date=  '{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_zendesk_usr_puc_santander', dag_id='LOAD_CMN_Zendesk') }}'
...
WHERE partition_date= '{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_zendesk_usr_comex_santander', dag_id='LOAD_CMN_Zendesk') }}';
...
where partition_date= '{{ ti.xcom_pull(task_ids='InputConfig', key='previous_partition_date', dag_id='LOAD_CMN_Zendesk') }}'
;
