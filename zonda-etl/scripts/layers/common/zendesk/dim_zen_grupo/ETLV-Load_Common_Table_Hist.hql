...
where partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_zendesk_gr_santander_ar', dag_id='LOAD_CMN_Zendesk_Hist2') }}'
...
where partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_zendesk_gr_puc_santander', dag_id='LOAD_CMN_Zendesk_Hist2') }}'
...
where partition_date='{{ ti.xcom_pull(task_ids='InputConfig', key='max_partition_zendesk_gr_comex_santander', dag_id='LOAD_CMN_Zendesk_Hist2') }}'