CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.bt_seg_bajas (
cod_per_nup              BIGINT,
...
cod_seg_familia          string,
ds_seg_familia           string,
cod_seg_anulacion        string,
ds_seg_anulacion         string
)
PARTITIONED BY (
  partition_date string)
STORED AS PARQUET
LOCATION
  '${DATA_LAKE_SERVER}/santander/bi-corp/common/seguros/fact/bt_seg_bajas'