...
case when bh.fec_pres in ('00000000','') then cast(null as string) else concat(substring(bh.fec_pres,1,4),'-',substring(bh.fec_pres,5,2),'-',substring(bh.fec_pres,7,2)) end as dt_chq_fechapresentacion,
case when bh.fec_deposito in ('00000000','') then cast(null as string) else concat(substring(bh.fec_deposito,1,4),'-',substring(bh.fec_deposito,5,2),'-',substring(bh.fec_deposito,7,2)) end as dt_chq_fechadeposito,
