CREATE EXTERNAL TABLE IF NOT EXISTS bi_corp_common.stk_chq_compensacion (
...
STORED AS PARQUET
LOCATION
  '${DATA_LAKE_SERVER}/santander/bi-corp/common/cheques/stk_chq_compensacion'