CREATE VIEW IF NOT EXISTS bi_corp_nuevo_cargabal.view_full_master_english AS
SELECT m.idcomb,
       m.continuing_operations, 
       a.description as classified_as_held_for_sale, 
       b.description as base,
       c.description as sub_base_1,
